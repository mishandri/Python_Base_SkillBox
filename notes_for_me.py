...
# STRING. Методы для работы со строками. Строки являются неизменяемыми объектами
my_string = 'Строка'
...
# LIST. Методы для работы со списками. Списки являются изменяемыми объектами
...
# TUPLE. Методы для работы с кортежами. Кортежи являются неизменяемыми объектами
my_tuple = (1, 2, 3)
